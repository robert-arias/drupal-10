 ...
 * @endcode
 */
$settings['hash_salt'] = 'hpLq5BIjV4GHWexqzc-YQfDriKt4_rWwW8mtHvRVtbDLzSMgagi_VyLSuSqCJim7lvO4yC66gg';
...
$secrets_settings = __DIR__ . "/settings.secrets.php";
if (file_exists($secrets_settings)) {
  include $secrets_settings;
}
